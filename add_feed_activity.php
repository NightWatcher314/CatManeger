...
if (isset($_POST['submit'])) {
    $query = "INSERT INTO feed(feed_time, feed_food,user_id, cat_id, feed_position) 
    VALUES (now(), '{$_POST['feed_food']}',{$user_id} ,{$_GET['cat_id']}, '{$_POST['feed_position']}')";
    execute($con, $query);
    ...
    <div class="container color-container">
        ...
        <form method="post" class="login-form">
            <div class="form-group">
                <input class="form-control login-field" type="text" name='feed_position' placeholder='地点' required>
                <br>
                <input class="form-control login-field" type="text" name='feed_image' placeholder='食物' required>
                <label class="login-field-icon fui-lock" for="login-pass"></label>
            </div>
            <input class="btn btn-primary btn-lg btn-block" type="submit" name='submit' value='投喂'>
        </form>
        <br>
    </div>
